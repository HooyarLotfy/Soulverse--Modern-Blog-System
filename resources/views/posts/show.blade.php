    ...
    <main>
            ...
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                ...
                <div class="flex flex-wrap items-center gap-4 mb-6 sm:mb-8 text-sm text-gray-600 dark:text-gray-400">
                    <div class="flex items-center gap-3 min-w-0">
                        ...
                        @endif
                        <div class="min-w-0">
                            <div class="font-semibold text-gray-900 dark:text-white truncate">{{ $post->user->name ?? 'Anonymous' }}</div>
        ...
        <section class="py-8 sm:py-12">
            <div class="max-w-5xl mx-auto px-2 sm:px-4 lg:px-8">
                ...
                <!-- Comment Form -->
                @auth
                    <form method="POST" action="{{ route('comments.store', $post) }}" class="mb-8 sm:mb-12">
                        @csrf
