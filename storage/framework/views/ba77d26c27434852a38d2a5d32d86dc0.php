...
<head>
    ...
    <title>Story Arcs | <?php echo e(config('app.name', 'SoulVerse')); ?></title>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <?php if(Auth::user() && Auth::user()->is_admin): ?>
                <div class="hero-cta">
                    <a href="<?php echo e(route('arcs.create')); ?>" class="btn btn-primary">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-4">
                    <?php $__currentLoopData = $arcs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="card group">
                            <a href="<?php echo e(route('arcs.show', $arc)); ?>" class="block h-full text-inherit no-underline">
                                <div class="relative overflow-hidden">
                                    <?php if($arc->cover_image): ?>
                                        <img src="<?php echo e(asset('storage/'.$arc->cover_image)); ?>" alt="<?php echo e($arc->title); ?>" class="w-full h-48 object-cover transition-transform duration-300 group-hover:scale-105">
                                    ...
                                    <div class="absolute top-4 right-4 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full px-3 py-1 text-sm font-medium text-gray-800 dark:text-gray-200 shadow-md">
                                        <?php echo e($arc->posts_count ?? 0); ?> <?php echo e(Str::plural('post', $arc->posts_count ?? 0)); ?>
                                ...
                                <div class="p-6">
                                    ...
                                    <?php if($arc->description): ?>
                                        <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm leading-relaxed line-clamp-3">
                                            <?php echo e($arc->description); ?>

                                        </p>
                                    <?php endif; ?>
                                    
                                    <div class="flex items-center justify-between text-sm text-gray-500 dark:text-gray-400">
                                        <span>Last updated: <?php echo e($arc->updated_at->diffForHumans()); ?></span>
                                    </div>
                                </div>
                            </a>
                        </article>
...
<?php /**PATH E:\Vs Code Projects\Laravel Projects\SoulVerse Web App\soulverse\resources\views/arcs/index.blade.php ENDPATH**/ ?>