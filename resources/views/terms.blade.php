...
@section('title', 'Terms of Service | ' . config('app.name', 'SoulVerse'))
@section('description', 'Terms of Service for SoulVerse - Read our terms and conditions for using our creative writing platform.')
