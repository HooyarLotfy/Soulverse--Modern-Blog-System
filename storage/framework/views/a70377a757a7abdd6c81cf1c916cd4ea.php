...
<head>
    ...
    <title><?php echo e(config('app.name', 'SoulVerse')); ?> - Where Stories Come Alive</title>
        ...
        <div class="hero-content">
            ...
            <div class="hero-cta">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('posts.create')); ?>" class="btn btn-primary">Start Writing</a>
                <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-primary">Join the Community</a>
                <?php endif; ?>
                <a href="<?php echo e(route('posts.index')); ?>" class="btn btn-secondary">Explore Posts</a>
            </div>
            
            <div class="hero-stats">
                <div class="stat">
                    <span class="stat-number"><?php echo e($posts->count()); ?></span>
                    <span class="stat-label">Stories</span>
                </div>
                <div class="stat">
                    <span class="stat-number"><?php echo e($comments->count()); ?></span>
        ...
        <section class="posts-section" style="margin-bottom: 4rem;">
            <div class="posts-grid">
                <?php $__empty_1 = true; $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <article class="post-card">
                        ...
                        <div class="post-content">
                            ...
                            <h3 class="post-title">
                                <a href="<?php echo e(route('posts.show', $post)); ?>" style="text-decoration: none; color: inherit;">
                            ...
                            <div class="post-footer">
                                <div class="post-author">
                                    ...
                                    <?php else: ?>
                                        <div class="author-avatar" data-avatar-user="<?php echo e($post->user->id); ?>">
                                            <?php echo e(strtoupper(substr($post->user->name, 0, 1))); ?>

                                        </div>
                                    <?php endif; ?>
                                    <span class="author-name"><?php echo e($post->user->name); ?></span>
                                </div>
                                
                                <div class="post-stats">
                                    <span>💬 <?php echo e($post->comments->count()); ?></span>
                                    <span>👁️ <?php echo e(rand(10, 500)); ?></span>
                                </div>
                            </div>
                        </div>
                    </article>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="empty-state">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('posts.create')); ?>" class="btn btn-primary">Create First Post</a>
                        <?php else: ?>
            ...
            <?php if($posts->count() > 0): ?>
                <div style="text-align: center; margin-top: 3rem;">
                    <a href="<?php echo e(route('posts.index')); ?>" class="btn btn-secondary">View All Posts</a>
                </div>
            <?php endif; ?>
        </section>
        ...
        <section class="latest-comments-section">
            ...
            <div class="latest-comments-grid">
                <?php $__empty_1 = true; $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="latest-comment-card" onclick="window.location.href='<?php echo e(route('posts.show', $comment->post)); ?>'">
                        <div class="latest-comment-author-section">
                            <?php if($comment->user->avatar): ?>
                                <div class="latest-comment-avatar">
                                    <img src="<?php echo e(asset('storage/'.$comment->user->avatar) . '?v=' . $comment->user->updated_at->timestamp); ?>" 
                                         alt="<?php echo e($comment->user->name); ?>"
                                         data-avatar-user="<?php echo e($comment->user->id); ?>"
                                         onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                            ...
                            <div class="latest-comment-user-info">
                                <div class="latest-comment-name"><?php echo e($comment->user->name); ?></div>
                                <div class="latest-comment-time"><?php echo e($comment->created_at->diffForHumans()); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="latest-comment-post-info">
                            <span>💬 on</span>
                            <span class="latest-comment-post-title"><?php echo e(Str::limit($comment->post->title, 50)); ?></span>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="latest-comments-empty">
                        ...
                        <a href="<?php echo e(route('posts.index')); ?>" class="btn btn-primary">Start Discussing</a>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <?php if($comments->count() > 0): ?>
                <div style="text-align: center; margin-top: 3rem;">
                    <a href="<?php echo e(route('posts.index')); ?>" class="btn btn-secondary">View All Discussions</a>
                </div>
            <?php endif; ?>
        </section>
    </main>
...
<?php /**PATH E:\Vs Code Projects\Laravel Projects\SoulVerse Web App\soulverse\resources\views/home.blade.php ENDPATH**/ ?>