...
<nav class="navbar">
    <div class="navbar-content">
        ...
        <div class="nav-links">
            ...
            <a href="<?php echo e(route('posts.index')); ?>" class="nav-link <?php echo e(request()->routeIs('posts.index') ? 'active' : ''); ?>">Explore</a>
            <a href="<?php echo e(route('arcs.index')); ?>" class="nav-link <?php echo e(request()->routeIs('arcs.index') ? 'active' : ''); ?>">Story Arcs</a>
            
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">Dashboard</a>
                <?php if(Auth::user()->is_admin): ?>
                    <a href="<?php echo e(route('arcs.create')); ?>" class="nav-link <?php echo e(request()->routeIs('arcs.create') ? 'active' : ''); ?>">New Arc</a>
                <?php endif; ?>
                ...
                <a href="<?php echo e(route('posts.create')); ?>" class="btn btn-primary">Write</a>
            <?php else: ?>
...
<div class="mobile-menu">
    ...
    <?php if(auth()->guard()->check()): ?>
        ...
        <?php if(Auth::user()->is_admin): ?>
            <a href="<?php echo e(route('arcs.create')); ?>" class="nav-link">New Arc</a>
        <?php endif; ?>
        <form method="POST" action="<?php echo e(route('logout')); ?>">
            <?php echo csrf_field(); ?>
            <a href="<?php echo e(route('logout')); ?>" class="nav-link"
    ...
    <?php else: ?>
        <a href="<?php echo e(route('login')); ?>" class="nav-link">Login</a>
        <a href="<?php echo e(route('register')); ?>" class="btn btn-primary" style="margin-top: 1rem; width: 100%;">Sign Up</a>
    <?php endif; ?>
...
<?php /**PATH E:\Vs Code Projects\Laravel Projects\SoulVerse Web App\soulverse\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>