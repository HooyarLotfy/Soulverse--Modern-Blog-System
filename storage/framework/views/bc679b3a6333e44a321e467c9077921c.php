...
<?php $__env->startSection('title', 'Edit Arc | ' . config('app.name', 'SoulVerse')); ?>
<?php $__env->startSection('description', 'Update the details for the story arc: ' . $arc->title); ?>
    ...
    <div class="container" style="max-width: 800px; margin: 6rem auto 3rem; padding: 0 1rem;">
        <div class="arc-form-container" style="background: white; border-radius: 1rem; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.05); padding: 2.5rem; margin-bottom: 2rem;" class="dark:bg-gray-800 dark:shadow-2xl">
            <div class="text-center mb-8">
                <h1 style="font-family: var(--font-serif); font-size: 2.5rem; font-weight: 700; margin-bottom: 1rem; color: var(--gray-800);" class="dark:text-white">Edit Story Arc</h1>
                <p style="color: var(--gray-500);" class="dark:text-gray-400">Refine the details of your narrative collection.</p>
            </div>
            
            <form action="<?php echo e(route('arcs.update', $arc)); ?>" method="POST" enctype="multipart/form-data" style="display: flex; flex-direction: column; gap: 1.5rem;">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" id="title" class="form-control" value="<?php echo e(old('title', $arc->title)); ?>" required style="width: 100%; padding: 0.75rem 1rem; border: 1px solid var(--gray-300); border-radius: 0.5rem; font-size: 1rem; transition: all 0.3s ease; color: var(--gray-800);" class="dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400">
                    <?php $__errorArgs = ['title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        <div style="color: var(--error); font-size: 0.875rem; margin-top: 0.5rem;"><?php echo e($message); ?></div>
                    <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" class="form-control" rows="4" required style="width: 100%; padding: 0.75rem 1rem; border: 1px solid var(--gray-300); border-radius: 0.5rem; font-size: 1rem; transition: all 0.3s ease; color: var(--gray-800); resize: vertical;" class="dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400"><?php echo e(old('description', $arc->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <?php if($arc->cover_image): ?>
                        <div class="mb-4">
                            <img src="<?php echo e(asset('storage/' . $arc->cover_image)); ?>" alt="Current cover image" class="rounded-lg max-w-xs">
                    ...
                    <div class="form-file" style="position: relative; display: flex; align-items: center; justify-content: center; border: 2px dashed var(--gray-300); border-radius: 0.5rem; padding: 2rem; cursor: pointer; transition: all 0.3s ease;" class="dark:border-gray-600 hover:border-primary dark:hover:border-primary">
                        <div id="file-upload-prompt" style="text-align: center;">
                            ...
                            <p style="color: var(--gray-500); font-weight: 500; margin-bottom: 0.5rem;" class="dark:text-gray-400">Upload a new image</p>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div style="display: flex; gap: 1rem; margin-top: 1.5rem; justify-content: flex-end;">
                    <a href="<?php echo e(route('arcs.show', $arc)); ?>" class="btn btn-secondary">Cancel</a>
...
<?php echo $__env->make('layouts.base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Vs Code Projects\Laravel Projects\SoulVerse Web App\soulverse\resources\views/arcs/edit.blade.php ENDPATH**/ ?>