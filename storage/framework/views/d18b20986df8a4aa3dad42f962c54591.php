...
<?php $__env->startSection('title', 'Create Arc | ' . config('app.name', 'SoulVerse')); ?>
<?php $__env->startSection('description', 'Create a new story arc to organize related posts.'); ?>
...
<main class="bg-gray-50 dark:bg-gray-900">
    <div class="container" style="max-width: 800px; margin: 6rem auto 3rem; padding: 0 1rem;">
        <div class="arc-form-container" style="background: white; border-radius: 1rem; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.05); padding: 2.5rem; margin-bottom: 2rem;" class="dark:bg-gray-800 dark:shadow-2xl">
            ...
            <form action="<?php echo e(route('arcs.store')); ?>" method="POST" enctype="multipart/form-data" style="display: flex; flex-direction: column; gap: 1.5rem;">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div style="display: flex; gap: 1rem; margin-top: 1.5rem; justify-content: flex-end;">
                    <a href="<?php echo e(route('arcs.index')); ?>" class="btn btn-secondary">Cancel</a>
...
<?php echo $__env->make('layouts.base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Vs Code Projects\Laravel Projects\SoulVerse Web App\soulverse\resources\views/arcs/create.blade.php ENDPATH**/ ?>