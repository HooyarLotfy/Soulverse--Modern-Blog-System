...
<footer class="footer">
    <div class="footer-content">
        ...
        <div class="footer-links">
            ...
            <a href="{{ route('posts.index') }}" class="footer-link">Posts</a>
            <a href="{{ route('arcs.index') }}" class="footer-link">Arcs</a>
        ...
        <div class="footer-bottom">
            <p>&copy; {{ date('Y') }} SoulVerse. Made with ❤️ for writers and readers.</p>
        </div>
    </div>
</footer>
