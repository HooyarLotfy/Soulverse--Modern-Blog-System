...
@section('title', 'Privacy Policy | ' . config('app.name', 'SoulVerse'))
@section('description', 'Privacy Policy for SoulVerse - Learn how we protect and handle your personal data on our creative writing platform.')
...
<div class="legal-container">
    <div class="legal-header">
        ...
        <p class="legal-date">Last updated: {{ date('F j, Y') }}</p>
    </div>
