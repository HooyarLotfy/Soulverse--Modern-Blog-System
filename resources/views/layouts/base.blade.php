...
<head>
    ...
    <title>@yield('title', config('app.name', 'SoulVerse'))</title>

    <!-- SEO Meta -->
    <meta name="description" content="@yield('description', 'A creative space for writers, storytellers, and readers.')">
    <meta name="keywords" content="blog, stories, writing, creative writing, community">
    <meta name="author" content="SoulVerse">

    <!-- Open Graph -->
    <meta property="og:title" content="@yield('title', config('app.name', 'SoulVerse'))">
    <meta property="og:description" content="@yield('description', 'A creative space for writers, storytellers, and readers.')">
