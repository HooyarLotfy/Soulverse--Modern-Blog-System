...
<head>
    ...
    <title>Dashboard | <?php echo e(config('app.name', 'SoulVerse')); ?></title>
    ...
    <meta property="og:url" content="<?php echo e(url('/dashboard')); ?>">
...
<section class="dashboard-hero">
    <div class="dashboard-hero-content">
        <h1 class="dashboard-title">Welcome back, <?php echo e(Auth::user()->name); ?>!</h1>
...
<main class="main-content">
    ...
    <div class="actions-grid">
        <?php if(Auth::user()->is_admin): ?>
            <a href="<?php echo e(route('posts.create')); ?>" class="action-card">
        ...
        <a href="<?php echo e(route('posts.index')); ?>" class="action-card">
        ...
        <a href="<?php echo e(route('arcs.index')); ?>" class="action-card">
    ...
    <div class="content-grid">
        ...
        <div class="content-section">
            <div class="section-header">
                ...
                <a href="<?php echo e(route('posts.index')); ?>" class="section-link">
                    View All Posts →
                </a>
            </div>
            ...
            <?php if($recentPosts->count() > 0): ?>
                <?php $__currentLoopData = $recentPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="post-item">
                        <h3 class="post-title">
                            <a href="<?php echo e(route('posts.show', $post)); ?>" style="color: inherit; text-decoration: none;">
                        ...
                        <div class="post-meta">
                            ...
                            <span><?php echo e($post->reactions_count ?? 0); ?> reactions</span>
                            <span><?php echo e($post->comments_count ?? 0); ?> comments</span>
                        </div>
                    </article>
        ...
        <div class="content-section">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-number"><?php echo e($totalPosts ?? 0); ?></div>
                    <div class="stat-label">Total Posts</div>
                </div>

                <div class="stat-card" style="background: linear-gradient(135deg, var(--secondary) 0%, #0891b2 100%);">
                    <div class="stat-number"><?php echo e($totalReactions ?? 0); ?></div>
                ...
                <div class="stat-card" style="background: linear-gradient(135deg, var(--accent) 0%, #d97706 100%);">
                    <div class="stat-number"><?php echo e($totalComments ?? 0); ?></div>
...
<?php /**PATH E:\Vs Code Projects\Laravel Projects\SoulVerse Web App\soulverse\resources\views/dashboard.blade.php ENDPATH**/ ?>